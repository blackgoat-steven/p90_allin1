              ...
              <div class="well">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <?php
                    foreach (dbFetchRows("SELECT `device_id`, `hostname`, `sysName` FROM `devices` ORDER BY `hostname`") as $data) {
                        echo("<option value='".$data['device_id']."'>".$data['hostname']."/".$data['sysName']."</option>");
                    }
