...
if ($format == "graph") {
    ...
    foreach (dbFetchRows($query, $sql_param) as $device) {
        ...
        if (device_permitted($device['device_id'])) {
            if (!$location_filter || $device['location'] == $location_filter) {
                ...
                echo $graph_type;
                if ($graph_type == 'device_ping_perf') {
                echo ' <iframe src="http://10.64.71.119:3000/dashboard-solo/script/device_ping_perf.js??orgId=1&panelId=1&hostname=' . $device['hostname'] . '&theme=light" style="width:100%;" height="200" frameborder="0"></iframe>';
                } else if($graph_type == 'device_processor'){
                echo ' <iframe src="http://10.64.71.119:3000/dashboard-solo/script/device_processor.js??orgId=1&panelId=1&hostname=' . $device['hostname'] . '&theme=light" width="450" height="200" frameborder="0"></iframe>';
                } else if($graph_type == 'device_uptime'){
                echo ' <iframe src="http://10.64.71.119:3000/dashboard-solo/script/device_uptime.js??orgId=1&panelId=1&hostname=' . $device['hostname'] . '&theme=light" width="450" height="200" frameborder="0"></iframe>';
                } else if($graph_type == 'device_poller_perf'){
                echo ' <iframe src="http://10.64.71.119:3000/dashboard-solo/script/device_poller_perf.js??orgId=1&panelId=1&hostname=' . $device['hostname'] . '&theme=light" width="450" height="200" frameborder="0"></iframe>';
                } else if($graph_type == 'device_ucd_load'){
                echo ' <iframe src="http://10.64.71.119:3000/dashboard-solo/script/device_ucd_load.js??orgId=1&panelId=1&hostname=' . $device['hostname'] . '&theme=light" width="450" height="200" frameborder="0"></iframe>';
                } else if($graph_type == 'device_mempool'){
                echo ' <iframe src="http://10.64.71.119:3000/dashboard-solo/script/device_mempool.js??orgId=1&panelId=1&hostname=' . $device['hostname'] . '&theme=light" width="450" height="200" frameborder="0"></iframe>';
                } else if($graph_type == 'device_storage'){
                echo ' <iframe src="http://10.64.71.119:3000/dashboard-solo/script/device_storage.js??orgId=1&panelId=1&hostname=' . $device['hostname'] . '&theme=light" width="450" height="200" frameborder="0"></iframe>';
                } else if($graph_type == 'device_storage'){
                echo ' <iframe src="http://10.64.71.119:3000/dashboard-solo/script/device_storage.js??orgId=1&panelId=1&hostname=' . $device['hostname'] . '&theme=light" width="450" height="200" frameborder="0"></iframe>';
                } else if($graph_type == 'device_diskio'){
                echo ' <iframe src="http://10.64.71.119:3000/dashboard-solo/script/device_diskio.js??orgId=1&panelId=1&hostname=' . $device['hostname'] . '&theme=light" width="450" height="200" frameborder="0"></iframe>';
                } else if($graph_type == 'device_temperature'){
                echo ' <iframe src="http://10.64.71.119:3000/dashboard-solo/script/device_temperature.js??orgId=1&panelId=1&hostname=' . $device['hostname'] . '&theme=light" width="450" height="200" frameborder="0"></iframe>';
                } else if($graph_type == 'device_bits'){
                echo ' <iframe src="http://10.64.71.119:3000/dashboard-solo/script/device_bits.js??orgId=1&panelId=1&hostname=' . $device['hostname'] . '&theme=light" width="450" height="200" frameborder="0"></iframe>';
                }
    ...
    <div class="table-responsive">
        <table id="devices" class="table table-hover table-condensed table-striped">
            <thead>
                <tr>
                    <th data-column-id="status" data-formatter="status" data-width="7px" data-searchable="false">Status</th>
                    ...
                    <th data-column-id="last_polled" data-visible="<?php echo $detailed  ? 'true' : 'false'; ?>">Last Polled</th>
    ...
    <script>
        var grid = $("#devices").bootgrid({
            ...
            formatters: {
                ...
                return "<span class=\"label label-font-border " + row.extra + "\">" + row.status + "</span>";
                },
                ...
                "lastpolled": function (column, row) {
                    return "<span>" + row.lastpolled + "<pre> sec</pre> </span>";
                },
