...
if (ObjectCache::portCounts(['total'], $device['device_id'])['total'] > 0) {
    ...
    if ($screen_width = Session::get('screen_width')) {
        ...
        //echo $db_name;
     echo ' <iframe src="/grafana/dashboard-solo/script/device_bits.js?orgId=1&panelId=1&hostname=' . $device['hostname'] . '&dbname=' . $db_name . '&theme=light"  height="' . $graph_array['height'] . '" frameborder="0"></iframe>';
     //echo 'http://g.babygoat.biz/grafana/dashboard-solo/script/device_bits.js?orgId=1&panelId=1&hostname=' . $device['hostname'] . '&dbname=' . $db_name . '&theme=light"  height="' . $graph_array['height'] . '';
    /*
