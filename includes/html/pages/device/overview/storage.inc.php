...
if (count($drives)) {
    ...
    echo '<i class="fa fa-database fa-lg icon-theme" aria-hidden="true"></i> <strong>Storage</strong>';
    echo '    </div>
    ...
    foreach ($drives as $drive) {
        ...
        echo '<tr>
           ...
           <td class="col-md-4">'. $drive['storage_descr'] . '</td>
           ...
           <td class="col-md-4">' . print_percentage_bar(200, 20, $percent, null, 'ffffff', $background['left'], $percent.'%', 'ffffff', $background['right']) . '
           </a></td>
         </tr>';
    }//end foreach
