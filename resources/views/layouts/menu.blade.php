...
{{-- Devices --}}
                <li class="dropdown">
                    ...
                    @admin
                        ...
                        <li><a href="{{ url('addhost') }}"><i class="fa fa-plus fa-fw fa-lg"
                                                              aria-hidden="true"></i> @lang('Add Device')</a></li>
                        <li><a href="{{ url('addhostmass') }}"><i class="fa fa-plus fa-fw fa-lg"
                                                              aria-hidden="true"></i> @lang('大量新增設備')</a></li>
                        <li><a href="{{ url('schedule') }}"><i class="fa fa-clock-o fa-fw fa-lg"
                                                              aria-hidden="true"></i> @lang('排程新增設備')</a></li>
                        <li><a href="{{ url('delhost') }}"><i class="fa fa-trash fa-fw fa-lg"
                                                              aria-hidden="true"></i> @lang('Delete Device')</a></li>
                        <li><a href="{{ url('delhostmass') }}"><i class="fa fa-trash fa-fw fa-lg"
                                                              aria-hidden="true"></i> @lang('大量刪除設備')</a></li>
                        <li><a href="{{ url('devicelog') }}"><i class="fa fa-bookmark fa-fw fa-lg"
                                                              aria-hidden="true"></i> @lang('設備異動記錄')</a></li>
                        <li role="presentation" class="divider"></li>
                        <li><a href="{{ url('services') }}"><i class="fa fa-cogs fa-fw fa-lg"
                                                              aria-hidden="true"></i> @lang('All Services')</a></li>
...
{{-- config --}}
                    <li class="dropdown">
                        ...
                        <li><a href="{{ url('ports') }}"><i class="fa fa-link fa-fw fa-lg" aria-hidden="true"></i> @lang('Ports')</a></li>
                ...
                <li class="dropdown">
                    <a href="{{ url('health') }}" class="dropdown-toggle" data-hover="dropdown"
                       data-toggle="dropdown"><i class="fa fa-heartbeat fa-fw fa-lg fa-nav-icons hidden-md"
                                                 aria-hidden="true"></i> <span class="hidden-sm">@lang('圖表分析')</span></a>
                    <ul class="dropdown-menu">
...
{{-- Alerts --}}
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ url('notifylog') }}"><i class="fa fa-file-text fa-fw fa-lg"
                                                                aria-hidden="true"></i> @lang('告警歷程')</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><i class="fa fa-user fa-fw fa-lg fa-nav-icons" aria-hidden="true"></i>
                       ...
                       <!-- <span class="badge badge-navbar-user count-notif {{ $notification_count ? 'badge-danger' : 'badge-default' }}">{{ $notification_count }}</span>a -->
</a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li role="presentation" class="divider"></li>
                        @endif
                        <!--<li><a href="{{ url('about') }}"><i class="fa fa-info-circle fa-fw fa-lg"                                                             aria-hidden="true"></i> @lang('About :project_name', ['project_name' => \LibreNMS\Config::get('project_name')])
                            </a></li>-->
                        <li><a href="{{ url('about') }}"><i class="fa fa-info-circle fa-fw fa-lg"                                                             aria-hidden="true"></i> @lang('About')
                            </a></li>
                    </ul>
                </li>
            </ul>
